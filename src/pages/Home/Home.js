                ...
                <div className="row mt-5">
                    <div className="col-lg-6 my-3">
                        ...
                        <div className="paragraph">
                            ...
                            help you translate English to the non-sense German language.
                            <br/>
                            <br/>
                            ...
                            Flask to easily define the endpoints. The machine learning model uses a model built using TensorFlow and OpenNMT.
                        </div>
                    </div>
